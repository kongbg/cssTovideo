    ...
    <div class="field-box">
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.vModel!==undefined && formConf.modeId && activeData.tag != 'el-button'" label="字段名">
            <el-select
          ...
          <!-- 事件 -->
          <el-form-item v-if="activeData.events!==undefined && activeData.events.length" label="事件">
            <el-select
                v-model="activeData.eventId"
                placeholder="请选择事件"
                :style="{width: '100%'}"
            >
                <el-option
                    v-for="item in activeData.events"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value">
                </el-option>
          ...
          <el-form-item v-if="activeData.width!==undefined" label="宽度">
            <el-input-number v-model="activeData.width" :min="0" placeholder="宽度"/>
          </el-form-item>
        ...
        <el-form v-if="false" size="small" label-width="90px">
