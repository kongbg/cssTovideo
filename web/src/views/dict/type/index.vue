<template>
    ...
    <Table border align="center" :tableData="tableInfo.tableData" :columns="columns" :loading="tableInfo.loading"
        ...
        <template #action="{ row }">
            ...
            <el-button size="small" type="primary" @click="handleButton('view', row)" text>查看字典值</el-button>
        </template>
    </Table>
...
import { create, update, getData as getList, getDetails, del } from '@/api/dictType.js'
